...
<head>
  <meta charset="utf-8">
    ...
    <title>MedQuest Admin - Log in </title>
...
<body class="hold-transition theme-light bg-dark">
...
<div class="row justify-content-center no-gutters">
    <div class="col-lg-4 col-md-5 col-12">
        <div class="content-top-agile p-10">
            <h2 class="text-white">MedQuest Pharmacy</h2>
            <p class="text-white-50">Admin Account Login Page</p>							
        </div>
