	  ...
	  <div class="container-full">
        ...
        @csrf
			...
			@enderror
                ...
                value="Lorem,Ipsum,Amet" data-role="tagsinput" data-role="tagsinput" required="">
            ...
            <div class="row" id="preview_img">
                    ...
                    <div class="controls">
                    <textarea name="short_desc" id="textarea" class="form-control" required placeholder="Textarea text" required=""></textarea>
                    </div>
                    </div>
                    </div> 
                    <!-- end col md 6 -->
                    ...
                    <textarea id="editor1" name="long_desc" rows="10" cols="80" required="">
												Please Insert the Product Long Description Here.
						</textarea>
                    </div>
                    </div>
                    </div> 
